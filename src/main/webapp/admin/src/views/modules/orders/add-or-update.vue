<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="yonghuming">
          <el-input v-model="ruleForm.yonghuming" 
              placeholder="商户名称" clearable  :readonly="ro.yonghuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssm5gd2j/upload');
        } else {
